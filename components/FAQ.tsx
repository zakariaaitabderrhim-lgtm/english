...
const faqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "جميع الحصص تتم عند بعد (أونلاين) عبر تطبيقات التواصل (Zoom, Google Meet) مما يمنحك المرونة الكاملة للتعلم من أي مكان."
    },
    {
        id: 5,
        question: "ما هي مؤهلات الأستاذ زكرياء؟",
        answer: "الأستاذ زكرياء أيت عبد الرحيم هو معلم لغة إنجليزية معتمد مع أكثر من 5 سنوات من الخبرة الميدانية. ساعد أكثر من 100 طالب في المغرب على تحقيق أهدافهم الأكاديمية والمهنية."
    },
    {
        id: 6,
